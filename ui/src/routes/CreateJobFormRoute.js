...
let isRunning = false;
const CreateJobFormRoute = (props, ref) =>{
    ...
    return(
        ...
        <div className={classes.btnContainer}>
         ...
         <section className={classes.sustainabilityContainer}>
         <img src={rail} alt='' className={classes.rail} />
         <header className={classes.sustainHeader}>Sustainability Week Event</header>
         <PromotionPane />
     </section>
     </>
    )
...
export default forwardRef(CreateJobFormRoute);